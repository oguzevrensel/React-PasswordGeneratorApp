...
const App = () => {
  ...
  const handleGeneratePassword = () => {
    if (!includeUpperCase && !includeLowerCase && !includeNumbers && !includeSymbols) {
      notify("Lütfen kutulardan en az birini seçin", true)
    }
    else {
      let characterList = ""
      if (includeNumbers) {
      ...
      notify("Şifre başarıyla oluşturuldu", false)
    }
      ...
      <div className="container">
        <div className="generator">
          ...
          <div className="form-group">
            <label htmlFor="password-strength">Şifre Uzunluğu</label>
          ...
          <div className="form-group">
            <label htmlFor="uppercase-letters">Büyük Harf Ekle</label>
          ...
          <div className="form-group">
            <label htmlFor="lowercase-letters">Küçük Harf Ekle</label>
          ...
          <div className="form-group">
            <label htmlFor="include-numbers">Sayı Ekle</label>
          ...
          <div className="form-group">
            <label htmlFor="include-symbols">Sembol Ekle</label>
